...
{
	private readonly GtkWidgetHandle _widget;
	private readonly string _blockElement;
	private readonly LinkedList<string> _modifiers = new();

	public BlockElementModifier(GtkWidgetHandle widget, string blockElement)
	{
		_widget = widget;
		_blockElement = blockElement;
	}

	public static BlockElementModifier Create(GtkWidgetHandle widget, string blockElement)
	{
